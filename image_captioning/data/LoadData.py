...
class ImageCaptionDataset(torch.utils.data.Dataset):
    def __init__(self, X_paths, y_labels, stoi_config, transforms=None): #device?
        ...
        self.start_tok_idx = stoi_config.stoi[stoi_config.start_token]
    ...
    def __getitem__(self, idx):
        ...
        int_label = [self.start_tok_idx] + [self.stoi_config.stoi[s] for s in str_label.split()] + [self.stop_tok_idx]
